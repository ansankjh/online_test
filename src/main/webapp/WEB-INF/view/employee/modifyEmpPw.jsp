								...
								<div class="col-lg-6">
								    <div class="p-5">
										<div class="text-center">
										    <h1 class="h4 text-gray-900 mb-2">${loginEmp.empName} 사원 비밀번호 수정</h1>
										</div>
										<div>${msg}</div>
										<form class="user" action="${pageContext.request.contextPath}/employee/modifyEmpPw" method="post" id="modifyForm">
											<!-- 아이디 -->
											<div class="form-group">
												<input type="text" class="form-control form-control-user" name="empId"
														readonly="readonly" value="${loginEmp.empId}">
											</div>
											<!-- 기존 비밀번호 -->
											<div class="form-group">
