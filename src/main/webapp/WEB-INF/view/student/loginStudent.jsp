	                            ...
	                            <div class="col-lg-6">
	                                <div class="p-5">
	                                    <div class="text-center">
	                                        <h1 class="h4 text-gray-900 mb-4">학생로그인</h1>
	                                    </div>
	                                    <form action="${pageContext.request.contextPath}/loginStudent" method="post">
	                                        <div class="form-group">
	                                            <input type="text" name="studentId" value="student" class="form-control form-control-user"
	                                                id="exampleInputEmail" aria-describedby="emailHelp">
	                                        </div>
	                                        <div class="form-group">
	                                            <input type="password" name="studentPw" value="123" class="form-control form-control-user"
